...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'symfony', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => 'qwertyuiop123', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager51aa0328bad39_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager51aa0328bad39_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/var/www/Symfony/app/cache/dev/jms_diextra/doctrine/EntityManager_51aa0328bad39.php';
        ...
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => '/var/www/Symfony/src/Acme/CallendarBundle/Entity', 1 => '/var/www/Symfony/src/Acme/UserBundle/Entity'));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'Acme\\CallendarBundle\\Entity');
        $f->addDriver($e, 'Acme\\UserBundle\\Entity');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('AcmeCallendarBundle' => 'Acme\\CallendarBundle\\Entity', 'AcmeUserBundle' => 'Acme\\UserBundle\\Entity'));
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager51aa0328bad39_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($h, $this);
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false)), 'Acme\\UserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha1', 1 => false, 2 => 1))));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/Symfony/src/Acme/CallendarBundle/Resources/views', 'AcmeCallendar');
        $instance->addPath('/var/www/Symfony/src/Acme/SecurityBundle/Resources/views', 'AcmeSecurity');
        $instance->addPath('/var/www/Symfony/src/Acme/UserBundle/Resources/views', 'AcmeUser');
     ...
     *
     * @return EntityManager51aa0328bad39_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AcmeCallendarBundle' => 'Acme\\CallendarBundle\\AcmeCallendarBundle',
            ...
            'database_user' => 'root',
            'database_password' => 'qwertyuiop123',
            ...
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/var/www/Symfony/app/cache/dev/jms_diextra/doctrine/EntityManager_51aa0328bad39.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager51aa0328bad39_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
